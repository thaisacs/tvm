...
void scoring_system_PAM30(scoring_t* scoring)
{
  ...
  // case_sensitive = 1
  scoring_init(scoring, 1, -17, -9, -1, 0, 0, 0, 0, 0, 1);
...
void scoring_system_PAM70(scoring_t* scoring)
{
  ...
  // no_start_gap_penalty, no_end_gap_penalty = 0
  // case_sensitive = 1
  scoring_init(scoring, 1, -11, -10, -1, 0, 0, 0, 0, 0, 1);
...
void scoring_system_BLOSUM80(scoring_t* scoring)
{
  ...
  // no_start_gap_penalty, no_end_gap_penalty = 0
  // case_sensitive = 1
  scoring_init(scoring, 1, -8, -10, -1, 0, 0, 0, 0, 0, 1);
...
void scoring_system_BLOSUM62(scoring_t* scoring)
{
  ...
  // no_start_gap_penalty, no_end_gap_penalty = 0
  // case_sensitive = 1
  scoring_init(scoring, 1, -4, -10, -1, 0, 0, 0, 0, 0, 1);
...
void scoring_system_DNA_hybridization(scoring_t* scoring)
{
  ...
  // no_start_gap_penalty, no_end_gap_penalty = 0
  // case_sensitive = 1
  scoring_init(scoring, 0, 0, -10, -10, 0, 0, 0, 0, 0, 1);
